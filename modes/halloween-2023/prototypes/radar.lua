...
radarEntityPrototype.localised_name = { "entity-name.jd_plays-halloween-2023-radar" }
radarEntityPrototype.localised_description = { "entity-description.jd_plays-halloween-2023-radar" }

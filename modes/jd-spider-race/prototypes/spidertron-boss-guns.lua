...
-- TODO: The artillery spider targets players, not just buildings. Only thing I can think of is to script in an artillery turret to the spiders position every second that the spider has artillery ammo.

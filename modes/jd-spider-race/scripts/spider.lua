...
local Settings = {
    bossSpiderStartingLeftDistance = 1500, -- How far left of spawn the center of the spiders area starts the game at.
    spiderDamageToRetreat = 5000,
    ...
    spiderDistanceToRetreat = 500, -- How far to increment a spider's distance to the left by when it is forced to retreat.
    spidersRoamingXRange = 250, -- How far left and right from the centre of a teams lane the spider will roam.
    ...
    distanceSpiderMovesinSecond = 21, -- Approximate distance a full speed boss spider will cover over 1 second. This is based on the spiders current speed and not for adhoc changing.
